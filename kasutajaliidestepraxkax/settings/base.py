"""
Django settings for Kasutajaliideste Prax Kaks project.
...
MANAGERS = ADMINS
EMAIL_SUBJECT_PREFIX = '[Kasutajaliideste Prax Kaks] '  # subject prefix for managers & admins

SESSION_COOKIE_NAME = 'kasutajaliidestepraxkax_ssid'
...
CACHES = {
    'default': {
        ...
        'KEY_PREFIX': 'kasutajaliidestepraxkax',
    }
}
...
ROOT_URLCONF = 'kasutajaliidestepraxkax.urls'

WSGI_APPLICATION = 'kasutajaliidestepraxkax.wsgi.application'
...
# Email config
DEFAULT_FROM_EMAIL = "Kasutajaliideste Prax Kaks <info@TODO.com>"
SERVER_EMAIL = "Kasutajaliideste Prax Kaks server <server@TODO.com>"
